defmodule PhoenixReactRenderExample.AuthenticationToken do
  @moduledoc """
  ...
  @impl true
  def token_config do
    default_claims(iss: "PhoenixReactRenderExample", aud: "PhoenixReactRenderExample", default_exp: @expiration_in_seconds)
  end
